    ...
    <div className="my-11 p-4">
      ...
      <div className="grid grid-cols-1 gap-[60px]">
        <div>
          ...
          <h3 className="text-2xl font-semibold py-3">COUNTRIES WEB APP</h3>
        ...
        <div>
          ...
          <h3 className="text-2xl font-semibold py-3">AUDIOPHILE E-COMMERCE WEBSITE</h3>
          <div className="flex gap-5 text-lg pb-5 ">
            <span>REACT</span>
            <span>JAVASCRIPT</span>
            <span>TAILWIND CSS</span>
        ...
        <div>
          ...
          <h3 className="text-2xl font-semibold py-3">TODO WEB APP</h3>
          <div className="flex gap-5 text-lg pb-5 ">
            <span>REACT</span>
            <span>JAVASCRIPT</span>
            <span>TAILWIND CSS</span>
        ...
        <div>
          ...
          <h3 className="text-2xl font-semibold py-3">EDUSITY COLLEGE WEBSITE</h3>
          <div className="flex gap-5 text-lg pb-5 ">
            <span>REACT</span>
            <span>JAVASCRIPT</span>
            <span>CSS</span>
